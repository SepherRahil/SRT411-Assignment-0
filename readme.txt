ASSIGNMENT 0 - SRT411
By: Sepehr Farahmand and Rahil Chadha

Introduction
R is an extremely powerful programming language designed to analyze big data.
A (very) short introduction to R is designed to provide us with a solid foundation for the R language.
This assignment will be going through the various "ToDo" tutorials in this book and familiarizing 
ourself with the syntax and structure of R code. 

Objective:
This assignment is designed to provide a solid introduction to the R language.
We will be exploring vectors, matrices, lists and other common data types.
We will also be assigning values to variables and creating graphs. 
Lastly, We will also be exploring ways to script using R such as for loops and if statements. 
